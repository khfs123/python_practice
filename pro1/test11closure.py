...
def outer():
    ...
    def inner() :
        ...
        count +=1
        return count
    return inner   # 요것이 클로저 : 내부 함수의 주소를 반환함


var1 = outer()
print('var 주소 : ', var1)    #var 주소 :  <function outer.<locals>.inner at 0x0000028EE6E33480>
print('count : ', var1())
print('count : ', var1())
...
# 형식 -- lambda 매개변수,... : 표현식     <== return 없이

def hapfunc(x, y):     # 프로그램 종료시까지 메모리를 유지
    return x + y
...
gg = lambda x, y:x + y  #<function <lambda> at 0x00000196808A3A00>
print(gg(1,2))
...
print('\n임의의 함수에서 람다 사용하기')
# filter() : 반복 가능한 객체(리스트 등)에서 특정 조건에 맞는 요소만 골라낼 때 사용.hapfunc
