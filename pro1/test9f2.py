...
print('--------------')
# doFunc2()  #TypeError : doFunc2() missing 1 required positior
doFunc2(7)
doFunc2("홍길동")
...
funcSoccer()
print(f'이름은 {name} 수준은 {player}')
# print(f'지역은 {city}') #NameError: name 'icity' is not defined
...
def foo():
    ...
    def bar():
        global c     # bar의 멤버가 아니라 모듈의 멤버(전역)
        nonlocal b
        b = 8 # 지역 변수
