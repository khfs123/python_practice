#매개변수 유형
#위치 매개변수 : 인수와 순서대로 대응
#기본값 매개변수 : 매개변수에 입력갑시 없으면 기본값 사용
...
print()
showGugu(7, end=9)
#showGugu(start=7, 9) # SyntaxError : positional argument follwers keywords
#showGugu(end = 9, 7) # SyntaxError : positional argument follwers keywords
...
# 몸무게:80, 키:180
# 기타 :{'irum': '신기해', 'nai': 33}
# fun3(80, 180, {'irum:신기해','nai':33}) #err
